                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <img src="{{ $company->logo }}" alt="Your logo" width="50px" hight="50px" loading="lazy">
                            @if($errors->has('logo'))
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="file" name="sign" class="form-control" id="sign" accept="image/*">
                            <img src="{{ $company->sign }}" alt="Your Logo" width="50px" hight="50px" loading="lazy">
                            @if($errors->has('sign'))
