...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">New Cuisine Item</h4>
        </div>
    </div>
</div>
<!-- end page title -->
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                {!! Form::open([
                'method' => 'POST',
                'action' => 'AdminCuisineItemsController@store',
                'files' => true,
                'class' => 'form-horizontal',
                'name' => 'addcuisineitemform',
                ]) !!}
                @csrf
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="cuisine_category_id">Menu Category<span class="text-danger">*</span></label>
...
<script>
    $(function() {
        ...
        $("form[name='addcuisineitemform']").validate({
            rules: {
                cuisine_category_id: {
                    required: true,
                },
