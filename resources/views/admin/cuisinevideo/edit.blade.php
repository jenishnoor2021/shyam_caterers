...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Edit Cuisine Video</h4>
        </div>
    </div>
</div>
<!-- end page title -->
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                {!! Form::model($item, [
                'method' => 'PATCH',
                'action' => ['AdminCuisineVideoController@update', $item->id],
                'files' => true,
                ...
                <div class="col-lg-1 align-self-center">
                    <div class="d-flex gap-2">
                        ...
                        <a class="btn btn-light mt-3 mt-lg-0" href="{{ URL::to('/admin/cuisine_video') }}">Back</a>
                    </div>
                </div>
                </form>
            </div>
