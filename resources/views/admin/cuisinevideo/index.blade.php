...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Cuisine Video</h4>
        </div>
    </div>
</div>
<!-- end page title -->
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                ...
                {!! Form::open([
                'method' => 'POST',
                'action' => 'AdminCuisineVideoController@store',
                'files' => true,
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                    <h4 class="card-title mb-0">Cuisine Videos</h4>
                </div>
...
<script>
    $(document).on('change', '.toggle-status-switch', function() {
        ...
        $.ajax({
            url: "{{ route('admin.cuisine_video.active') }}",
            type: "POST",
            data: {
                _token: "{{ csrf_token() }}",
                id: agentId
