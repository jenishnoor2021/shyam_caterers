...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Edit Events</h4>
        </div>
    </div>
</div>
<!-- end page title -->
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                {!! Form::model($event, [
                'method' => 'PATCH',
                'action' => ['AdminEventsController@update', $event->id],
                'files' => true,
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="event_type" class="form-control text-uppercase" id="name" placeholder="Enter event type" value="{{ $event->event_type }}" required>
                            @if ($errors->has('event_type'))
                            <div class="error text-danger">{{ $errors->first('event_type') }}
                            </div>
                            @endif
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="file" name="poster" class="form-control" id="poster" value="" accept="image/*">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="file" name="file" class="form-control" id="file"
                                placeholder="Enter file" value="{{ $event->file }}" accept="image/*">
                            <img src="{{ $event->file }}" alt="file" width="50px" hight="50px" loading="lazy">
                            @if ($errors->has('file'))
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <textarea type="text" name="detail" class="form-control" id="detail" placeholder="Enter content" required>{{ $event->detail }}</textarea>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="is_active" id="is_active" class="form-control" style="width:100%" required>
                                <option value="1" {{ $event->is_active == '1' ? 'selected' : '' }}>Show</option>
                                <option value="0" {{ $event->is_active == '0' ? 'selected' : '' }}>Hide</option>
                            </select>
