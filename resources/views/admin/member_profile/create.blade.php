                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" name="contact" class="form-control" id="contact" placeholder="Enter contact No" value="{{ old('contact') }}" required pattern="[0-9]{10}" maxlength="10">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" name="whatsapp_no" class="form-control" id="whatsapp_no" placeholder="Enter whatsapp No" value="{{ old('whatsapp_no') }}" required pattern="[0-9]{10}" maxlength="10">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="youtube" class="form-control" id="youtube" placeholder="Enter youtube link" value="{{ old('youtube') }}" required>
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="map" class="form-control" id="map" placeholder="Enter map" value="{{ old('map') }}" required>
                            @if($errors->has('map'))
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="website" class="form-control" id="website" placeholder="Enter website link" value="{{ old('website') }}" required>
...
<script>
    $(function() {
        ...
        $("form[name='addprofileform']").validate({
            rules: {
                name: {
                    required: true,
                },
