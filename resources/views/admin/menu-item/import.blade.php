...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Menu Item Import</h4>
        </div>
    </div>
</div>
<!-- end page title -->
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('admin.menu-item.import-store') }}" name="menuItemImport" method="POST"
...
<script>
    $(function() {
        ...
        $("form[name='menuItemImport']").validate({
            rules: {
                file: {
                    required: true,
                },
