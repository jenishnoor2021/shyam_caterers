...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Menu Item</h4>
        </div>
    </div>
</div>
<!-- end page title -->
                        ...
                        <span id="menu-navi"
                            ...
                            <div class="d-flex align-items-center gap-2 flex-wrap mb-3">
                                <a class="btn btn-info waves-effect waves-light"
                                    href="{{ route('admin.menu-item.create') }}"><i class="fa fa-plus editable" style="font-size:15px;">&nbsp;ADD</i></a>
                                <a class="btn btn-primary waves-effect waves-light" href="{{ route('admin.menu-item.import') }}" style="font-size:15px;">
                                    Import
                                </a>

                                <form method="GET" action="{{ route('admin.menu-item.index') }}" id="filterForm" class="d-flex ms-5">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                ...
                                <a href="{{ route('admin.menu-item.destroy', $item->id) }}"
...
<script>
    $(document).on('change', '.toggle-status-switch', function() {
        ...
        $.ajax({
            url: "{{ route('admin.menu-item.active') }}",
            type: "POST",
            data: {
                _token: "{{ csrf_token() }}",
                id: agentId
