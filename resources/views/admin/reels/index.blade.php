...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Reels</h4>
        </div>
    </div>
</div>
<!-- end page title -->
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                ...
                {!! Form::open([
                'method' => 'POST',
                'action' => 'AdminReelController@store',
                'files' => true,
                ...
                <div class="row">
                    <div class="mb-3">
                        ...
                        <input type="number" name="priority" class="form-control" id="priority" placeholder="Enter priority" value="" required>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                    <h4 class="card-title mb-0">Reels</h4>
                </div>
                            ...
                            <td>
                                <div class="form-check form-switch">
                                    <input class="form-check-input toggle-status-switch" type="checkbox"
                                        id="toggleSwitch{{ $reel->id }}" data-id="{{ $reel->id }}"
                                        {{ $reel->is_active ? 'checked' : '' }}>
                                    <label class="form-check-label" for="toggleSwitch{{ $reel->id }}">
                                        {{ $reel->is_active ? 'Show' : 'Hide' }}
                                    </label>
                                </div>
                            </td>
                        </tr>
...
<script>
    $(function() {
        $("form[name='addReelForm']").validate({
            rules: {
                file: {
                    required: true,
                },
