...
<body>
                ...
                <form action="{{ route('booking.submit') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="tel" name="phone_no" id="phone_no" class="form-control" placeholder="Enter mobile number" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="event_date" id="event_date" class="form-control datetimepicker" placeholder="Enter event Date" required>
                        ...
                        <table class="table table-bordered align-middle" id="functionTable">
                            ...
                            <tbody id="functionRows">
                                <tr>
                                    ...
                                    <td><input type="text" name="functions[0][person]" class="form-control" placeholder="Enter person" required></td>
    ...
    <script>
        ...
        function addFunctionRow() {
            ...
            <td><input type="datetime-local" name="functions[${index}][datetime]" class="form-control" required></td>
            <td class="action">
        ...
        function toggleRemoveButtons() {
            ...
            rows.forEach((row, i) => {
                ...
                if (rows.length === 1) {
                    ...
                    actionCell.innerHTML = `<button type="button" class="btn btn-sm btn-danger" onclick="removeFunctionRow(this)">Remove</button>`;
                }
            });
        }
