        ...
        <div class="event-content">
            ...
            <div class="section-grid">
                <div class="menu-section">
                    <div style="background: #e9ecef; padding: 5px; font-size: 12px; margin-bottom: 5px;">
                        <strong>Date:</strong> {{ $eventDate }} &nbsp;
                        <strong>Time:</strong> {{ $eventTime }} &nbsp;
                        <strong>Persons:</strong> {{ $eventPersons }}
                    </div>
                    ...
                    <table width="100%" style="border-collapse: collapse; font-size: 12px; margin-top: 10px;">
                        ...
                        <tr>
                            <td style="width: 25%; vertical-align: top; font-weight: bold; padding: 5px; border: 1px solid #000;">
                                {{ strtoupper($category) }}
                            </td>
